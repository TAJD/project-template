...
remote per `apps/docs/src/content/docs/start/new-project.md`) merge future template updates safely.
...
- **Deleted-module conflicts resolve "keep deleted."** If a downstream
  project followed an `apps/docs/src/content/docs/modules/*.md` removal doc to delete a module
  ...
  the module's `apps/docs/src/content/docs/modules/*.md` file, and any touch-point edits (routes,
...
yet beyond what's already described in `apps/docs/src/content/docs/modules/*.md` and `AGENTS.md`.
