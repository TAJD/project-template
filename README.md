...
- **Account module** — Drizzle/D1 users + sessions, WebCrypto PBKDF2 password
  ...
  auth for automated suites. See the [account module page](https://tajd.github.io/project-template/modules/account/).
- **Billing module** — Stripe Checkout, customer-portal redirect, webhook
  ...
  the [billing module page](https://tajd.github.io/project-template/modules/billing/).
- **Blog module** — an MDX-backed blog with drafts, tags, RSS/Atom feeds, and
  ...
  the [blog module page](https://tajd.github.io/project-template/modules/blog/).
...
- **Feedback module** — a thumbs-up/down + optional comment widget, env-gated
  ...
  the [feedback module page](https://tajd.github.io/project-template/modules/feedback/).
- **R2 range-request proxy** — a `/data/*` worker route serving R2 objects with
  ...
  the [R2 proxy module page](https://tajd.github.io/project-template/modules/r2-proxy/).
...
the [documentation site](https://tajd.github.io/project-template/modules/) — delete what a given project
doesn't need.
...
checklist: [New project checklist](https://tajd.github.io/project-template/start/new-project/).
...
deleted-module conflicts — are documented on the [staying up to date](https://tajd.github.io/project-template/start/updating/) page, and
per-entry in [`CHANGELOG.md`](CHANGELOG.md).

## Developing on Windows

Issues specific to Windows (not exercised by this template's Linux CI) are
documented on the [developing on Windows](https://tajd.github.io/project-template/start/windows-notes/)
page.
